...
const required = ["DATABASE_URL", "AUTH_TOKEN_SECRET", "PII_ENCRYPTION_KEY", "WEBHOOK_SIGNING_SECRET", "AUTOMATION_JOB_SECRET", "POSTMARK_SERVER_TOKEN", "POSTMARK_FROM_EMAIL", "GOOGLE_ADDRESS_VALIDATION_API_KEY", "SHOPIFY_ADMIN_ACCESS_TOKEN", "SHOPIFY_WEBHOOK_SECRET", "SHIPSAVING_API_KEY", "THRIVE_API_BASE_URL", "THRIVE_API_TOKEN", "GIGS_API_TOKEN", "OBJECT_STORAGE_BUCKET", "OBJECT_STORAGE_ACCESS_KEY_ID", "OBJECT_STORAGE_SECRET_ACCESS_KEY", "GOOGLE_STAFF_OAUTH_CLIENT_ID"] as const;
